...
class DemoMerchantSeeder extends Seeder
{
    public function run(): void
    {
        ...
        MerchantWebhook::firstOrCreate(['merchant_id'=>$merchant->id,'url'=>'https://webhook.site/demo'], ['secret'=>'demo_webhook_secret','events'=>['shipment.created','shipment.status_changed','delivery.delivered','cod.collected'],'status'=>'active']);
        $rateCard = RateCard::firstOrCreate(['code' => 'DEFAULT'], ['name'=>'Default Courier Rate Card','status'=>'active']);
        RateRule::firstOrCreate(['rate_card_id'=>$rateCard->id,'origin_city'=>null,'destination_city'=>null,'min_weight'=>0,'max_weight'=>5], ['base_charge'=>200,'extra_per_kg'=>60,'cod_percent'=>1,'cod_fixed'=>10,'return_charge'=>100,'estimated_delivery_time'=>'2-4 days','status'=>'active']);
