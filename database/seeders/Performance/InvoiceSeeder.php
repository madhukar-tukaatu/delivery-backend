...
class InvoiceSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($invoiceIds as $inv) {
            $items[] = ['invoice_id'=>$inv->id,'description'=>'Courier delivery and COD service charges','quantity'=>1,'unit_price'=>$inv->total_amount,'total'=>$inv->total_amount,'created_at'=>now(),'updated_at'=>now()];
